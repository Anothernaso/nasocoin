    ...
    fun loginTestRequestHandler(ctx: Context) {
        ...
        try {
            ...
            ctx
                ...
                .json(
                    ErrorPayload(
                        "Could not test login of user account",
        ...
        try {
            ...
            ctx
                ...
                .json(
                    ErrorPayload (
                        "Test results for user account '${payload.userIdentifier}'",
                        "No such user"
                    )
                )
            return
